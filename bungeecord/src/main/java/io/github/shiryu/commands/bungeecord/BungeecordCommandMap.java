...
public class BungeecordCommandMap implements Listener {
    ...
    @EventHandler
    public void tabComplete(final TabCompleteResponseEvent event){
        ...
        for (CommandExecutable executable : commandManager.getCommands()){
            final String cmdLine = executable.getName();
