package io.github.shiryu.commands.bungeecord.command;
...
public class BungeeExecutable extends CommandExecutable {

    public BungeeExecutable(@NotNull final CommandHandler base, @NotNull final String[] names,
